...
def test_is_request_local():
    ...
    assert (
        is_request_local(MockRequest({"x-forwarded-for": "127.0.0.1"}, "203.0.113.1"))
        is False
    )
    ...
    assert (
        is_request_local(MockRequest({"x-forwarded-for": "203.0.113.1"}, "127.0.0.1"))
        is False
    )
    assert (
        is_request_local(MockRequest({"x-real-ip": "203.0.113.1"}, "127.0.0.1"))
        is False
    )
    ...
    assert (
        is_request_local(
            MockRequest({"x-forwarded-for": "203.0.113.1, 127.0.0.1"}, "127.0.0.1")
        )
        is False
    )
    ...
    assert (
        is_request_local(MockRequest({"x-forwarded-for": "127.0.0.1"}, "127.0.0.1"))
        is True
    )
