...
| F-4 | Minor | Hygiene | lifecycle status block (docs/build-stream/2026-08-22-istara-pi-model-management-migration.md) | F-1 approval hold marker lost + stale planning text: L-40 (18cd7d32) set blocked_on to the VPS port-contract approval; c316bd67 reverted it to null 13s later, L-41 (3d737e4c) left it null, ab1afdcd reverted L-41's next_action to stale planning text — fix evidence claim "blocked_on set (L-40)" false at HEAD | REREV-ISTARA-PI-MODEL-MIGRATION-20260822-WAVE-qa-docs-vps-REVIEW-r1 | open — re-asserted L-43 (FIX-...-REVIEW-r1-hygiene, 26b69058) but clobbered a THIRD time by owner-gate sync commit 466035e0 (+73s, blocked_on->null, next_action->stale planning text); r2 verdict FAIL; durable fix on FIX-REREV-...-REVIEW-r2-hygiene (id 44, wave_id qa-docs-vps) — bare status-block re-assertion proven non-durable (no in-repo sync script) |
