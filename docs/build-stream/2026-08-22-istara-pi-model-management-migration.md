...
last:
  ...
  at: 2026-08-22T18:10:04Z
  ledger: L-41
next_action: "Delta re-review (REREV) of the F-2/F-3 registry + hygiene fix surface; then ship (owner-gated). F-1 VPS deployment pending owner approval (port-contract.md §5)."
```
