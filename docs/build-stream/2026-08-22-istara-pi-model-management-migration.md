...
| F-4 | Minor | Hygiene | lifecycle status block (docs/build-stream/2026-08-22-istara-pi-model-management-migration.md) | F-1 approval hold marker lost + stale planning text: L-40 (18cd7d32) set blocked_on to the VPS port-contract approval; c316bd67 reverted it to null 13s later, L-41 (3d737e4c) left it null, ab1afdcd reverted L-41's next_action to stale planning text — fix evidence claim "blocked_on set (L-40)" false at HEAD | REREV-ISTARA-PI-MODEL-MIGRATION-20260822-WAVE-qa-docs-vps-REVIEW-r1 | fixed — FIX-...-REVIEW-r1-hygiene (L-43): blocked_on hold restored and re-asserted at fix head (5a03737e re-asserted L-42; 6287182e external owner-gate sync clobbered again; L-43 re-asserts); owner-approval gate for port-contract.md §5 (18443/tcp) machine-visible in status block |
| F-5 | Minor | Hygiene | .compass-forge/conductor/consensus.json candidates.a.plan_file | F-3a duplicate removed but consensus winner plan_file still names the removed docs/build-stream/plans/istara-pi-model-migration-20260822-master-a.md (dangling; not tracked, not on disk); winner content preserved byte-identical at the canonical tracked path (blob 69ddf68e == consensus plan_blob_oid) | REREV-ISTARA-PI-MODEL-MIGRATION-20260822-WAVE-qa-docs-vps-REVIEW-r1 | fixed — FIX-...-REVIEW-r1-hygiene (L-43): consensus.json candidates/a/plan_file + cast.json wave_binding.winner.plan_file repointed to the canonical committed path (blob 69ddf68e, sha 10096535…, tracked); zero dangling refs in live conductor state |
