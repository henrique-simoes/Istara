...
- Use the visible controls in this surface to work with autoresearch dashboard in the active project context.
...
- Project-scoped state or artifact updates associated with autoresearch dashboard.
