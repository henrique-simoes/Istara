...
test_references: ["tests/test_tasks.py", "tests/test_loops.py", "tests/test_autoresearch.py", "tests/test_agent_learning_scope.py", "tests/test_meta_hyperagent.py", "tests/test_skills.py", "tests/test_file_watcher_config.py"]
