...
code_references: ["frontend/src/components/common/ComputePoolView.tsx", "backend/app/api/routes/compute.py", "backend/app/core/compute_pool.py"]
...
- Tests: `tests/test_compute_registry_model_loading.py`, `tests/test_compute_registry_hardening.py`, `tests/test_network_discovery.py`
