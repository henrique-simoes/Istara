...
- The traceability API joins reports, finding ids, task ids, coding runs, code applications, reconciliation decisions, and graph edges so project users can inspect which reports or tasks still depend on low-agreement evidence before synthesis or reporting.
