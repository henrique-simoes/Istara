...
- When no custom intro is configured, activation uses a grammatical article for the deployment type (for example, “an interview”); custom intro text is preserved as entered.
