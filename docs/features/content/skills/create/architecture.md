...
test_references: ["tests/test_skills.py", "tests/test_improvement_governance.py", "tests/test_project_scope_contracts.py", "tests/test_simulation_project_scope_contracts.py", "tests/simulation/lib/api-client.mjs", "tests/simulation/scenarios/41-skill-creation.mjs"]
last_verified: 2026-05-19
compass: CF-SPEC-53 / CF-657; CF-SPEC-76 / CF-972; CF-SPEC-104 / CF-1309
---
...
- Skill creation simulation checks pass `ctx.projectId` to creation proposal routes and record a scoped skip when the runner has not supplied an active project.
...
- Spec/task: CF-SPEC-53 / CF-657; CF-SPEC-76 / CF-972; CF-SPEC-104 / CF-1309
