...
| `docs/architecture/retrieval-graph-agentic-map.html` | Interactive map of the retrieval (FTS5 BM25 + LanceDB + weighted RRF), evidence-graph and agent learning systems as the code implements them, how each is measured, and the September 2026 findings register with fix status. |
