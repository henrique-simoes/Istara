...
LEGACY_COMPASS_DOCS = [
    ...
    ROOT / "GEMINI.md",
    ROOT / "PROJECT_ISOLATION_GOAL_SPECIFICATION.md",
    ROOT / "QWEN.md",
    ROOT / "SYSTEM_INTEGRITY_GUIDE.md",
    ROOT / "SYSTEM_PROMPT.md",
    ROOT / "docs" / "CODEBASE_HEALTH_PASS.md",
    ROOT / "docs" / "PROJECT_SCOPE_AND_RENDERING_ASSESSMENT.md",
    ROOT / "scripts" / "update_agent_md.py",
]
