...
> Authority: This is not the canonical development-governance document set. For live architecture, workflow, and change-preservation guidance, start with `AGENTS.md`, Compass Forge, and `AGENTS.md`.
