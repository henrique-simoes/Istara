...
> Authority: Useful as a wiki-facing reference, but not the canonical internal development source of truth. For live API inventory and change obligations, start with `AGENTS.md`, Compass Forge, and `AGENTS.md`.
