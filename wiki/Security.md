...
> Authority: Useful for wiki/security guidance, but not the canonical internal development-control entrypoint. For live repo doctrine and change obligations, start with `AGENTS.md`, Compass Forge, and `DOCUMENTATION.md`.
