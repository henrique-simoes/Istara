...
- **Generated:** `2026-07-31T19:14:44Z`
...
| `none` | `legacy` | `22` | `11` | startup_failure×11 |
| `none` | `pi` | `22` | `10` | startup_failure×10 |
...
2. **Legacy arm routing:** benchmark legacy units dispatch through the benchmark-isolated approved provider adapter (F-10), not ComputeRegistry production routing; results describe the legacy *loop*, not legacy-with-donated-compute.
