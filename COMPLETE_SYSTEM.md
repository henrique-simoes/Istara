...
Generated from the repository on version `2026.04.04.3`. This document is meant to be regenerated whenever the implementation changes so LLMs can reason from the current system instead of stale summaries.
