...
class SkillUpdateProposal:
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "field": self.field,
            "current_value": self.current_value[:200] + "..." if len(self.current_value) > 200 else self.current_value,
            "proposed_value": self.proposed_value[:200] + "..." if len(self.proposed_value) > 200 else self.proposed_value,
            "reason": self.reason,
