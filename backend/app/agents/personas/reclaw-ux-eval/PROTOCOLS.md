...
Scenario: Alex opens ReClaw for the first time. She has 8 interview transcripts to analyze.
...
5. Combined report is sent to ReClaw for task board prioritization
