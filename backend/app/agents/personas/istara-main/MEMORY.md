# Istara Research Coordinator -- Persistent Memory
...
- When encountering 'SkillOutput.__init__() got an unexpected keyword argument 'json_success'', resolve by: Returned task to backlog for retry
### Workflow Patterns
