...
| Simulation scenarios | `tests/simulation/scenarios/*.mjs` | 82 scenario files plus 11 static helper test files under `tests/simulation/lib/*.test.mjs` at the 2026-09-11 checkpoint (test:static 41/41; browser lane 2026-09-11: 15 PASS + 1 SKIP, 248 checks, 82 15/15 / 83 17/17 / 84 13/13; proven-extra 8 journeys, resolve 15/67/0). | Browser/API scenarios against a running app, registered through `tests/simulation/run.mjs`; `npm run test:static` is the PR-safe syntax/project-selection smoke layer. |
